    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto py-6 px-4">
        ...
        <header className="mb-8">
          ...
          <p className="text-sm text-black mb-1">Designer in Austin</p>
          <p className="text-sm text-black">@patrickm02L</p>
        </header>
        ...
        <section>
          ...
          <div className="space-y-1">
            <div className="flex gap-2">
              <span className="text-black text-xs w-24">Instagram</span>
              <a href="https://www.instagram.com/patrickm02l" target="_blank" rel="noopener noreferrer" className="text-black text-xs hover:underline">patrickm02L</a>
            </div>
            <div className="flex gap-2">
              <span className="text-black text-xs w-24">LinkedIn</span>
              <a href="https://www.linkedin.com/in/patrickm02l/" target="_blank" rel="noopener noreferrer" className="text-black text-xs hover:underline">patrickm02L</a>
            </div>
          </div>
        </section>
      </div>
